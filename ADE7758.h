...
// Class Atributes
#define AFECS 5             // Chip Select ADE7758 - It is the pin to which the AFE is connected (Pin 5 as CS in our case)
...
class ADE7758 
{
	...
	void setAPCFDEN(int d);
	int getAPCFDEN();
	void setAPCFNUM(int d);
	int getAPCFNUM();
	void setVARCFDEN(int d);
	int getVARCFDEN();
	void setVARCFNUM(int d);
	int getVARCFNUM();
	void setAVRMSGAIN(int d);
	int getAVRMSGAIN();
	void setBVRMSGAIN(int d);
	int getBVRMSGAIN();
	void setCVRMSGAIN(int d);
	int getCVRMSGAIN();
	void setAWG(int d);
	int getAWG();
	void setBWG(int d);
