/** ADE7758.cpp 
====================================================================================================
Analog Front End for the three-phase Metering system.
*/  
#include <string.h>
#include <Arduino.h>
#include <SPI.h>
...
bool ADE7758::Init(void) 
{
	...
	//SPI.setDataMode(SPI_MODE2);		// Dataout falling edge and data input at rising edge as described on page 56 of ADE7758 datasheet
	//SPI.setClockDivider(SPI_CLOCK_DIV32);
	delay(100);
	if(getLcycMode() == 0x78)
		return true;
...
unsigned char ADE7758::read8(char reg)
{
	...
	disableChip();
	//SPI.endTransaction();
	// return (unsigned char)SPI.transfer(0x00);
	return b0;
}
...
/** === write24 ===
* Write 24 bits to the device at specified register
* @param reg: char containing register direction
* @param data: int, 24 bits of data to send
*
*/
...
void ADE7758::setAWattOffset(int32_t o)
{
  write16(AWATTOS, o);
}
int ADE7758::getAWattOffset()
{
	return ((read16(AWATTOS))<<4)>>4;
}
void ADE7758::setBWattOffset(int32_t o)
{
  write16(BWATTOS, o);
}
void ADE7758::setCWattOffset(int32_t o)
{
  write16(CWATTOS, o);
}

void ADE7758::setAVAROffset(int32_t o)
{
  write16(AVAROS, o);
}
void ADE7758::setBVAROffset(int32_t o)
{
  write16(BVAROS, o);
}
void ADE7758::setCVAROffset(int32_t o)
{
  write16(CVAROS, o);
}
...
char ADE7758::setPotLine(char Phase, int Cycles)
{
	long lastupdate = 0;
	char m = 0;
	char temp = 0;
	...
	setLineCyc(Cycles);
	lastupdate = millis();
	while(!(getStatus() & LENERGY))   // Wait to finish accumulation
	{ // wait for the selected interrupt to occur
		if ((millis() - lastupdate) > (Cycles*15)) 
		{
			temp = 1;		
			break;  
		}
...
Returns the values ​​of the required power of the selected phase.
Use setPotLine (phase) before to generate the values.
**/
...
void ADE7758::setAPCFDEN(int d)
{
	write16(APCFDEN,d);
}
int ADE7758::getAPCFDEN()
{
	return ((read16(APCFDEN))<<4)>>4;
}
void ADE7758::setAPCFNUM(int d)
{
	write16(APCFNUM,d);
}
int ADE7758::getAPCFNUM()
{
	return read16(APCFNUM);
}
// VARCFDEN/ VARCFNUM
void ADE7758::setVARCFDEN(int d)
{
	write16(VARCFDEN,d);
}
int ADE7758::getVARCFDEN()
{
	return ((read16(VARCFDEN))<<4)>>4;
}
void ADE7758::setVARCFNUM(int d)
{
	write16(VARCFNUM,d);
}
int ADE7758::getVARCFNUM()
{
	return read16(VARCFNUM);
}
// Set AVRMS GAIN
void ADE7758::setAVRMSGAIN(int d)
{
	write16(AVRMSGAIN,d);
}
int ADE7758::getAVRMSGAIN()
{
	return ((read16(AVRMSGAIN))<<4)>>4;
}
void ADE7758::setBVRMSGAIN(int d)
{
	write16(BVRMSGAIN,d);
}
int ADE7758::getBVRMSGAIN()
{
	return ((read16(BVRMSGAIN))<<4)>>4;
}
void ADE7758::setCVRMSGAIN(int d)
{
	write16(CVRMSGAIN,d);
}
int ADE7758::getCVRMSGAIN()
{
	return ((read16(CVRMSGAIN))<<4)>>4;
}
// WATT GAIN ADJUSTMENT
void ADE7758::setAWG(int d)
{
	write16(AWG,d);
}
int ADE7758::getAWG()
...
void ADE7758::setBWG(int d)
{
	write16(BWG,d);
}
int ADE7758::getBWG()
{
	return ((read16(BWG))<<4)>>4;
}
void ADE7758::setCWG(int d)
{
	write16(CWG,d);
}
int ADE7758::getCWG()
{
	return ((read16(CWG))<<4)>>4;
}
// VAR GAIN ADJUSTMENT
void ADE7758::setAVARG(int d)
{
	write16(AVARG,d);
}
int ADE7758::getAVARG()
{
	return ((read16(AVARG))<<4)>>4;
}
void ADE7758::setBVARG(int d)
{
	write16(BVARG,d);
}
int ADE7758::getBVARG()
{
	return ((read16(BVARG))<<4)>>4;
}
void ADE7758::setCVARG(int d)
{
	write16(CVARG,d);
}
int ADE7758::getCVARG()
{
	return ((read16(CVARG))<<4)>>4;
}
// VA GAIN ADJUSTMENT
void ADE7758::setAVAG(int d)
{
	write16(AVAG,d);
}
int ADE7758::getAVAG()
{
	return ((read16(AVAG))<<4)>>4;
}
void ADE7758::setBVAG(int d)
{
	write16(BVAG,d);
}
int ADE7758::getBVAG()
{
	return ((read16(BVAG))<<4)>>4;
}
void ADE7758::setCVAG(int d)
{
	write16(CVAG,d);
}
int ADE7758::getCVAG()
{
	return ((read16(CVAG))<<4)>>4;
}
char ADE7758::getTemperature()
{
	return read8(TEMP);
}